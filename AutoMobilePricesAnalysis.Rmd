---
title: " *Auto Mobile Price Analysis Project* "
author: " *Author : Omar Soub* "
date: " *Date : 23/05/2024* "
output:
  cleanrmd::html_document_clean:
    theme: water-dark # NULL
    toc: yes
    toc_float: 
      collapsed: true
...
* *Note : You can look directly into the project in Rpubs by visting 'http://rpubs.com/omars/1196926' or [click here](http://rpubs.com/omars/1196926)* 
----------------------------------------------
...
```{r eval=FALSE, fig.width=10, message=FALSE, warning=FALSE, include=FALSE}
DataExplorer::plot_scatterplot(numerical_data,by="price")
```

```{r eval=FALSE, include=FALSE}
plot_boxplot(df, by = "num_of_doors")
```
